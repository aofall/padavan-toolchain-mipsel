...
#define __KERNEL_HEADERS__ "$(ROOTDIR)/src/mipsel-linux-uclibc-toolchain/include"
...
#define __CROSS_COMPILER_PREFIX__ "$(PREFIX)/bin/mipsel-linux-uclibc-"
